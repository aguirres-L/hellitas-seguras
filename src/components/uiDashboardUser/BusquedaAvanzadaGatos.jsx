...
export default function BusquedaAvanzadaGatos({ onRazaSeleccionada, razaSeleccionada }) {
  // Estados locales
  ...
  // Opción especial para gatos mestizos
  const opcionMestizo = {
    id: 'mestizo',
    nombre: 'Mestizo (Criollo)',
    tipo: 'especial',
    descripcion: 'Gato de raza mixta o sin raza específica'
  };
  ...
  const razasFiltradas = useMemo(() => {
    ...
    const palabrasMestizo = ['mestizo', 'criollo', 'callejero', 'cruce', 'mixto', 'sin raza', 'común'];
          ...
          <div className="flex items-start">
            ...
            <div className="text-left">
              <p className="text-sm text-amber-800 font-medium">
                ¿Por qué es importante identificar la raza de tu gato?
              </p>
              <p className="text-xs text-amber-700 mt-1">
                Cada raza tiene necesidades específicas de cuidado, ejercicio y salud. 
                Esto nos permite darte consejos personalizados para tu compañero felino.
              </p>
            </div>
          </div>
        </div>
                  ...
                  >
                    <div className="flex items-center">
                      ...
                      <div className="flex-1">
                        ...
                        {raza.descripcion && raza.tipo !== 'especial' && (
                          <div className="text-sm text-gray-500 mt-1 line-clamp-2">
                            {raza.descripcion.substring(0, 80)}...
                          </div>
                        )}
                        {raza.tipo === 'especial' && (
            ...
            <div className="flex items-center justify-center">
              <div className="text-center">
                ...
                <div className="text-sm text-green-600 mt-1">
                  Gato de raza mixta o sin raza específica
                </div>
                <div className="text-xs text-green-500 mt-2">
                  ¡Todos los gatos merecen el mejor cuidado!
                </div>
              </div>
            </div>
          </button>
        ...
        <div className="flex items-start">
          ...
          <div className="ml-3">
            <p className="text-sm text-blue-700">
              <strong>Tip:</strong> Si tu gato es mestizo, selecciona "Mestizo (Criollo)" para recibir consejos generales. 
