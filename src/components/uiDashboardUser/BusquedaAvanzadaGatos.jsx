    ...
    <div className="space-y-4">
      <div className="text-left">
        ...
        <details className="mt-2 rounded-lg border border-amber-200/80 bg-amber-50/90 text-left">
          ...
          <p className="px-2.5 pb-2.5 text-xs text-amber-800 leading-snug border-t border-amber-100">
            Cada raza tiene hábitos y cuidados distintos. Con este dato afinamos las recomendaciones para tu gato.
          </p>
        </details>
      </div>
      ...
      <div className="rounded-xl border border-gray-200 bg-white shadow-sm overflow-hidden">
        <div className="p-3 sm:p-4 space-y-3">
          <div>
            <label htmlFor="busqueda-raza-gato" className="block text-sm font-medium text-gray-800">
              Buscar raza
            </label>
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      {raza.descripcion && raza.tipo !== 'especial' && (
                        <div className="text-xs text-gray-500 mt-0.5 line-clamp-2">{raza.descripcion.substring(0, 80)}…</div>
                      )}
                      {raza.tipo === 'especial' && (
