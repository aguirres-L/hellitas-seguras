            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div>
                <div className="flex items-center mb-6">
                  ...
                  {datosOng?.logoUrl ? (
                    <div className="w-16 h-16 rounded-2xl overflow-hidden mr-4 flex-shrink-0 border-2 border-white shadow-md bg-white">
                      <img 
                        ...
                        onError={(e) => {
                          ...
                          parent.innerHTML = '<div class="w-full h-full bg-orange-500 flex items-center justify-center"><span class="text-white text-2xl">🐾</span></div>';
                        }}
                      />
                    </div>
                  ) : (
                ...
                <div className="flex flex-wrap gap-4 mb-6">
                  {datosOng?.estimativoRescates ? (
                    <div className="flex items-center text-sm text-gray-600">
                      ...
                      +{datosOng.estimativoRescates.toLocaleString('es-CL')} mascotas rescatadas
                    </div>
                  ) : (
                    <div className="flex items-center text-sm text-gray-600">
                      <span className="w-2 h-2 bg-green-500 rounded-full mr-2"></span>
                  ...
                  {datosOng?.estimativoAdopciones ? (
                    <div className="flex items-center text-sm text-gray-600">
                      ...
                      +{datosOng.estimativoAdopciones.toLocaleString('es-CL')} adopciones exitosas
                    </div>
                  ) : (
                    <div className="flex items-center text-sm text-gray-600">
                      <span className="w-2 h-2 bg-blue-500 rounded-full mr-2"></span>
              ...
              <div className="text-center md:text-left">
                <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-6 md:p-8 shadow-xl border border-orange-100 hover:shadow-2xl transition-all duration-300">
                  {/* Icono decorativo */}
                  <div className="flex justify-center md:justify-start mb-4">
                    <div className="w-14 h-14 bg-gradient-to-r from-orange-400 to-pink-500 rounded-full flex items-center justify-center shadow-lg">
                      <span className="text-2xl">🐾</span>
                    </div>
                  </div>
                  
                  <h5 className="text-xl md:text-2xl font-bold text-gray-800 mb-3">
                  ...
                  <button 
                    onClick={() => infoAdoptar()}
                    className="w-full bg-gradient-to-r from-orange-500 to-pink-500 hover:from-orange-600 hover:to-pink-600 text-white font-bold py-3 md:py-4 px-6 md:px-8 rounded-xl text-base md:text-lg transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 flex items-center justify-center gap-2"
                  >
                  ...
                  <div className="mt-4 flex items-center justify-center md:justify-start gap-2 text-xs text-gray-500">
                    ...
                    <span>Proceso 100% gratuito y responsable</span>
                  </div>
                </div>
              </div>
            </div>
